...
# Esta é a definição da função. É como a receita de um bolo.
...
# V-- PONTO MAIS IMPORTANTE --V
# Esta parte abaixo é o "botão de partida".
# Ela diz ao Python: "Quando este arquivo for executado, rode a função acima".
# Sem isso, o script não faz nada.
